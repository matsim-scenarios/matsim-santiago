package org.matsim.santiago.colectivos;
...
public class ReadColectivoShape {
	...
	private void run(){
		...
		new MatsimNetworkReader(network).readFile("C:/Users/Felix/Documents/Bachelor/Santiago de Chile/org.matsim.santiago/scenario/inputForMATSim/network/network_merged_cl.xml.gz");
...
//		Map<String,String> fleet = readExcelFileAndExtractFleet("C:/Users/Felix/Documents/Bachelor/Santiago de Chile/Shape-Files/Resumen_Geocodificacion.csv");
		Map<String,String> interval = readCSVFileAndExtractInterval("C:/Users/Felix/Documents/Bachelor/Santiago de Chile/v1/org.matsim.santiago/outputWithCollectivo(FC_SC1)/Traveltimes3(AddedEmptyLines).csv");
...
//			}
		...
		new MatsimVehicleReader(scenario.getTransitVehicles()).readFile("C:/Users/Felix/Documents/Bachelor/Santiago de " +
													   "Chile/org.matsim.santiago/scenario/inputForMATSim/transit/old/transitvehicles.xml" );
 		new TransitScheduleReader(scenario).readFile(				"C:/Users/Felix/Documents/Bachelor/Santiago de Chile/org.matsim.santiago/scenario/inputForMATSim/transit/old/transitschedule_simplified.xml");
