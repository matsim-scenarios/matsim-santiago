...
import org.matsim.santiago.analysis.eventHandlers.others.SantiagoTestDepartures;

public class SantiagoTests {
	
	final static String plansFile = "../../../runs-svn/org.matsim.santiago/baseCase1pct/outputOfStep1/ITERS/it.500/500.plans.xml.gz";
	final static String eventsFile = "../../../runs-svn/org.matsim.santiago/baseCase1pct/outputOfStep1/ITERS/it.500/500.events.xml.gz";
