...
public class ConfigToBaseCases {
	...
	final static String svnWorkingDir = "../../../shared-svn/projects/org.matsim.santiago/scenario/inputForMATSim/";
	...
	final static String runsClusterDir = "/net/ils4/lcamus/runs-svn/org.matsim.santiago/" + baseCase10pct + "/";
	final static String runsLocalDir = "../../../runs-svn/org.matsim.santiago/" + baseCase1pct + "/";
