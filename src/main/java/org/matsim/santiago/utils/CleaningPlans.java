...
public class CleaningPlans {
	...
	static String originalPlansFile = "../../../runs-svn/org.matsim.santiago/baseCase1pct/outputOfStep0/output_plans.xml.gz";
	
	//for step1-e1 and step1-e2, stepA1, stepP1_1, stepSP1_0
	
	static String selectedPlansFile = "../../../runs-svn/org.matsim.santiago/baseCase1pct/outputOfStep0/selected_output_plans.xml.gz";
