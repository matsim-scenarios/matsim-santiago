...
public class Plans2Shape {
	...
	private String svnWorkingDir = "../../../shared-svn/projects/org.matsim.santiago/scenario/inputForMATSim/";
	private String santiagoNetwork = svnWorkingDir + "network/network_merged_cl.xml.gz";
	
	
	private String runsWorkingDir = "../../../runs-svn/org.matsim.santiago/baseCase10pct/";
