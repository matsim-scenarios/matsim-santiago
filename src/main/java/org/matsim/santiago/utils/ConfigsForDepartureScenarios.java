...
public class ConfigsForDepartureScenarios {
	...
	private static final String INPUT_CONFIG = "../../../shared-svn/projects/org.matsim.santiago/scenario/inputForMATSim/expanded_config_0.xml";

	private static String caseName="baseCase10pct";
	private static String stepName="Step2xA";
	private static double sampleSize = 0.1;

	private static String runDir = "../../../runs-svn/org.matsim.santiago/" + caseName + "/";
