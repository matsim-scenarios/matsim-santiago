...
package org.matsim.santiago.prepare.counts;
...
public class CreateCountingStations {
	...
	private static final String svnWorkingDir = "../../../shared-svn/projects/org.matsim.santiago/scenario/";	//Path: KT (SVN-checkout)
