...
package org.matsim.santiago.population;
...
//	final String pathForMatsim = "../../../runs-svn/org.matsim.santiago/run20/";
//	final boolean prepareForModeChoice = false;
	final String pathForMatsim = "../../../runs-svn/org.matsim.santiago/TMP/";
	final boolean prepareForModeChoice = true;
	
	final int writeStuffInterval = 50;
	final int nrOfThreads = 6;

	final String svnWorkingDir = "../../../shared-svn/projects/org.matsim.santiago/scenario/";
	...
	/**
	 * Creates an initial population for the org.matsim.santiago scenario, executing the following steps:
	 * <ol>
